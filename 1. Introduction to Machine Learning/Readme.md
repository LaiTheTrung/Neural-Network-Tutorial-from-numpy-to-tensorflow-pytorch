...
one note that during the whole tutorial, I assume that you have a basic foundation in python. In case you are a newer, please go back to learning something about python, include:
* python syntax
* numpy library
